(function(global){
  ...
  function saveSession(user){
    sessionStorage.setItem(KEY, JSON.stringify({userId:user.id || user.userId, id:user.id || user.userId, username:user.username, displayName:user.displayName || user.username, phone:user.phone || '', role:user.role, vendorId:user.vendorId || '', employeeId:user.employeeId || '', at:Date.now()}));
  }
