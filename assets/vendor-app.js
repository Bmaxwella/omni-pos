(function(global){
  ...
  async function acceptDelivery(assignmentId){
    ...
    UI.toast('Delivery accepted. Enable live tracking to share your location','ok');
    renderDeliveries();
  }
